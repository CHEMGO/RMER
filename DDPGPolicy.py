...
class DDPGPolicy(BasePolicy):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.ready_env_ids = np.arange(len(self.env))
    ...
    def _target_q(self, buffer: ReplayBuffer, indices: np.ndarray) -> torch.Tensor:
        ...
        # print('target q info:')
        # print('obs, act, rew, obs_next, info: {},{},{},{},{}'.format(batch.obs, batch.act, batch.rew, batch.obs_next,
        #                                                              batch.info))
    ...
    def _mse_optimizer(
        ...
        # print('current q info:')
        # print('obs, act, rew, obs_next, info: {},{},{},{},{}'.format(batch.obs, batch.act, batch.rew, batch.obs_next,
        #                                                              batch.info))
        weight = getattr(batch, "weight", 1.0)
        # print('weight:{}'.format(weight))
        current_q = critic(batch.obs, batch.act).flatten()
        # print('current q:{}'.format(current_q))
        target_q = batch.returns.flatten()
        # print('target q:{}'.format(target_q))
